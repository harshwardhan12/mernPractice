...
export const handleFollowRequest = async (req, res) => {
  try {
    ...
    if (!user.followRequests.includes(requestSenderId)) {
      return res
        .status(404)
        .json({ message: "No follow request found", success: false });
    }
    ...
    if (action === "accept") {
      ...
      return res
        .status(200)
        .json({ message: "Follow request accepted", success: true });
      ...
      return res
        .status(200)
        .json({ message: "Follow request rejected", success: true });
    }
...
export const removeFollower = async (req, res) => {
  try {
    ...
    if (!user.followers.includes(followerId)) {
      return res
        .status(400)
        .json({ message: "This user is not following you.", success: false });
    }
    ...
    return res
      .status(200)
      .json({ message: "Follower removed successfully", success: true });
  } catch (error) {
